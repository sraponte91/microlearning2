      ...
      <div class="container margin-0-auto">
        <div class="row">
          <div class="col-md-12 text-center leader-title">
            ...
            <p class="text-orange">
              Un espacio donde su liderazgo tendrá impacto nacional
            </p>
          </div>
          <div class="col-md-12">
            <div class="sec1-boxes">
              ...
              <div class="sec1-description">
                ...
                <p>
                  La Red de Ángeles Inversionistas es un programa que apuesta
                  por la transformación social de negocios rentables y
                  sostenibles. Esta Red busca generar un cambio en la narrativa
                  de la inversión de riesgo y de impacto para crecer como
                  sociedad. Así mismo, creamos espacios y conexiones de valor
                  para apoyar a los empresarios locales por medio de
                  herramientas y metodologías que les permitan fortalecer sus
                  capacidades para el levantamiento de capital e inversión con
                  impacto.
                </p>
              </div>
            </div>
            ...
            <div class="sec2-boxes">
              <div class="sec2-inner-box">
                ...
                <p>
                  ...
                  habilidades adquiridas, para escribir y presentar un Reto de
                  Emprendimiento. Esta evaluación final puede ser muy versátil,
                  dependiendo de los intereses, creatividad y antecedentes de
                  cada participante.
                </p>
              ...
              <div class="sec2-inner-box">
                ...
                <p>
                  ...
                  extensa experiencia dentro de su industria. Son, además,
                  profesionales que cuentan con un espíritu emprendedor innato,
                  y tienen una capacidad de inversión entre el 5% y el 20% de su
                  patrimonio, con la cual le apostarán a start-ups o en empresas
