  ...
  <main>
    ...
    <section class="main-slider-at-top aflora-pge position-relative after-po">
      ...
      <div class="pg-tit-inner position-absolute text-center">
        <h1 class="ff-sans-b">Voluntariado Familia Bolivar</h1>
      </div>
    </section>

    <section
      class="ig-tx-zing-zag bg-white position-relative what-we-do connoz-filamr-mpg"
    >
      <HomeDots></HomeDots>
      <div class="container">
        <div class="d-flex multiple-reapt align-items-start flex-wrap-991">
          <div class="txt-points position-relative">
            ...
            <div class="pra-p">
              <p>En Voluntariado Familia Bolívar buscamos empoderar a aquellos que quieren asumir el reto de convertirse en agentes de cambio dentro de sus comunidades aportando su tiempo y conocimiento desde diferentes áreas y disciplinas.</p>
            </div>
          </div>
        ...
        >
          ...
          <div class="txt-points position-relative order-1-991">
            <div class="pra-p">
                 <p>Actualmente, el programa trabaja con más de 9.200 voluntarios en 5 países: Colombia, Costa Rica, El Salvador, Panamá y Honduras.. El objetivo del programa es continuar expandiéndose y seguir llegando a los rincones del mundo donde nadie llega, para sembrar una semilla de cambio y transformación, donde sea que se necesite.</p>
                    <p>Voluntariado Familia Bolívar trabajamos diferentes líneas de voluntariado:</p>
              <ul>
                <li class="position-relative after-po">Capacitación y herramientas para trabajar con emprendedores, finanzas personales, convivencia saludable, o apoyo a la formación educativa de niños y niñas.</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <section class="six-statetic-box-e full-wid">
      <div class="container">
