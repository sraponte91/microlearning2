      ...
      <div class="container">
        <div class="sm-siz-container margin-0-auto">
          <div class="d-flex multiple-reapt align-items-start flex-wrap-991">
            ...
            <h3 class="ff-sans-b ss d-block-991 d-none-n">
              ¿Cómo inscribirse <br />
              a Aflora?
            </h3>
              ...
              <div class="pra-p for-bgcol">
                <ul>
                  <li class="position-relative after-po">
                    Pertenecer al Grupo Bolívar en alguno de estos perfiles:
                    pensionado/a, familiar de un colaborador del Grupo Bolívar,
                    o ser un colaborador directo.
                  </li>
                  <li class="position-relative after-po">
                    Querer aportar conocimiento, herramientas y talento humano
                    para cada una de las jornadas que el programa ofrece a lo
                    largo del año. Esto incluye jornadas presenciales y
                    virtuales.
                  </li>
                  <li class="position-relative after-po">
                    En caso de ser necesario, cumplir con el perfil de algunas
                    campañas que buscan profesionales o trabajadores de ciertas
                    áreas en particular.
                  </li>
                </ul>
              </div>
          ...
          <div class="txt-info-m margin-0-auto text-center">
            ...
            <div class="pra-p ff-nunito">
              <p>
                ...
                detalle las políticas detrás de cada iniciativa. Por eso, lo
                invitamos a leer con detenimiento el reglamento del programa
                Voluntariado Familia Bolívar, donde encontrará los requisitos y
                condiciones para ser parte del programa.
              </p>
            </div>
            <div
