...
export default {
  head() {
    return {
      title: this.$constants
        .voluntariadoFundacionBolivarDaviviendaDesarrollamosTalento.meta.title,
      meta: [
        {
          hid: 'title',
          name: 'title',
          content: this.$constants
            .voluntariadoFundacionBolivarDaviviendaDesarrollamosTalento.meta
            .metaTitle,
        },
        {
          hid: 'description',
