    ...
    <section class="requisitos">
      <div class="container margin-0-auto">
        <div class="pm-title border-orange">
          ...
          <p>
            Conoce los portales aliados donde podrás aprender mientras te
            diviertes.
          </p>
        </div>
      </div>
...
.zona-img {
  ...
  border-radius: 4px;
  background: #f7f7f7;
  box-shadow: 0px 0px 15px rgba(17, 24, 32, 0.3);
  display: flex;
  align-items: center;
