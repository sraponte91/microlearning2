          ...
          <div id="colombia" class="container tab-pane active">
            <div class="tab-main">
              ...
              <div class="contact-details">
                <h2>CUNDINAMARCA</h2>
                <h3>Bogotá</h3>
                <h2>Alcaldía de Pacho</h2>
                <h2>Coordinador</h2>
                <a href="milto:bosa@fcultivarte.org">
                  <img src="/images/email.svg" alt="" /> bosa@fcultivarte.org
                </a>
              </div>
            </div>
          </div>
          <div id="el-salvador" class="container tab-pane fade">
            <div class="tab-main">
              ...
              <div class="contact-details">
                ...
                <h2>Coordinador</h2>
                <a href="milto:bosa@fcultivarte.org"
                  ><img src="/images/email.svg" alt="" />bosa@fcultivarte.org</a
                >
              </div>
            </div>
          </div>
