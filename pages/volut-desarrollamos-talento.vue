          ...
          <div class="d-flex multiple-reapt align-items-start flex-wrap-991">
            ...
            <div class="txt-points position-relative order-2-991">
              ...
              <div class="pra-p for-bgcol">
                <p>Mediante las jornadas de capacitación y formación desarrollamos y cultivamos el talento de todos y todas las participantes, para unirnos, transformar y multiplicar en cada uno de los territorios donde Voluntariado Familia Bolívar tiene presencia. </p>
               <p>Adicionalmente, el programa brinda la oportunidad a sus voluntarios de crecer como agentes de cambio, y por eso impulsa y apoya campañas y proyectos sociales propuestos por ellos. Buscamos formar más y mejores voluntarios para que cada vez la red de intercambio de conocimiento sea mayor.</p>                
              </div>
            </div>
