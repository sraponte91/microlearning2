    ...
    <a id="scroll" href="javascript:void(0)" @click="scrollToTop()">
      <span>
        <svg version="1.2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
          overflow="visible" preserveAspectRatio="none" viewBox="0 0 24 24" width="39" height="39">
          <g>
            <path id="arrow-up" xmlns:default="http://www.w3.org/2000/svg"
              ...
              style="fill: rgb(119, 119, 122)" vector-effect="non-scaling-stroke" />
          </g>
        </svg>
      </span>
    </a>
          ...
          <div>
            <client-only>
              <div class="accordion" role="tablist">
                ...
                <b-card no-body>
                  <b-card-header header-tag="header" role="tab">
                    <b-button block v-b-toggle.accordion-8 variant="info" class="ff-sans-b">
                      <div class="d-flex justify-content-between">
                        <p>Teléfono</p>
                        <i class="ic-accordion position-relative"></i>
                      </div>
                  ...
                  <b-collapse id="accordion-8" accordion="my-accordions" role="tabpanel">
                    <b-card-body>
                      <b-card-text>
                        <ul class="ff-sans-r">
                          <li>
                ...
                <b-card no-body>
                  <b-card-header header-tag="header" role="tab">
                    <b-button block v-b-toggle.accordion-9 variant="info" class="ff-sans-b">
                      <div class="d-flex justify-content-between">
                        <p>Fax</p>
                        <i class="ic-accordion position-relative"></i>
                      </div>
                  ...
                  <b-collapse id="accordion-9" accordion="my-accordions" role="tabpanel">
                    <b-card-body>
                      <b-card-text>
                        <ul class="ff-sans-r">
                          <li>
          ...
          <div class="logo-social-m">
            ...
            <div class="social-m">
              ...
              <div class="set-of-icon">
                <a href="https://www.facebook.com/fundacionbolivardavivienda/" target="_blank"><svg version="1.2"
                    ...
                    <g>
                      <path id="facebook" xmlns:default="http://www.w3.org/2000/svg"
                        ...
                        style="fill: rgb(135, 135, 135)" vector-effect="non-scaling-stroke" />
                    </g>
                  </svg></a>
                <a href="https://www.instagram.com/fundacionbd/" target="blank"><svg version="1.2"
                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" overflow="visible"
                    preserveAspectRatio="none" viewBox="0 0 24 24" width="32" height="32">
                    <g>
                ...
                <a href="https://www.linkedin.com/company/fundaci%C3%B3n-bol%C3%ADvar-davivienda/" target="_blank"><svg
                ...
                <a href="https://twitter.com/FundacionBD?lang=es" target="_blank"><svg version="1.2"
                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" overflow="visible"
                    preserveAspectRatio="none" viewBox="0 0 24 24" width="32" height="32">
                    <g>
                ...
                <a href="https://www.youtube.com/channel/UCEcX3O1scgTJ9qpLwrpEb-A" target="_blank"><svg version="1.2"
                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" overflow="visible"
                    preserveAspectRatio="none" viewBox="0 0 24 24" width="32" height="32">
                    <g>
